...
J.ready(function(){
  ...
  if(linkWrapper!=undefined){
    J.tag("head").append(J.new("style").html("#tjLinks{margin: 5px;}.tj-link{text-decoration: underline;margin: 0 5px;font-size: 20px;cursor:pointer;}.tj-link:hover{color:#aaa;}@media screen and (max-width:1000px) {.tj-link{font-size: 15px;}}"));
